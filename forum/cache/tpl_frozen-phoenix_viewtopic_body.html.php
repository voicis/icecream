...
<?php echo (isset($this->_tpldata['DEFINE']['.']['MG_BLOCK_H_BEGIN'])) ? $this->_tpldata['DEFINE']['.']['MG_BLOCK_H_BEGIN'] : ''; ?><a href="<?php echo (isset($this->_rootref['U_VIEW_TOPIC'])) ? $this->_rootref['U_VIEW_TOPIC'] : ''; ?>"><?php echo (isset($this->_rootref['TOPIC_TITLE'])) ? $this->_rootref['TOPIC_TITLE'] : ''; ?></a><?php echo (isset($this->_tpldata['DEFINE']['.']['MG_BLOCK_H_END'])) ? $this->_tpldata['DEFINE']['.']['MG_BLOCK_H_END'] : ''; ?>
