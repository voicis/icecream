...
<?php } if ($this->_rootref['S_SHOW_TOPICS']) {  if (sizeof($this->_tpldata['searchresults'])) {  ?>
	...
	<?php echo (isset($this->_tpldata['DEFINE']['.']['MG_BLOCK_H_BEGIN'])) ? $this->_tpldata['DEFINE']['.']['MG_BLOCK_H_BEGIN'] : ''; if ($this->_rootref['S_DISPLAY_ACTIVE']) {  echo ((isset($this->_rootref['L_ACTIVE_TOPICS'])) ? $this->_rootref['L_ACTIVE_TOPICS'] : ((isset($user->lang['ACTIVE_TOPICS'])) ? $user->lang['ACTIVE_TOPICS'] : '{ ACTIVE_TOPICS }')); } else if ($_topicrow_val['S_TOPIC_TYPE_SWITCH'] && $_topicrow_val['S_TOPIC_TYPE'] > (1)) {  echo ((isset($this->_rootref['L_ANNOUNCEMENTS'])) ? $this->_rootref['L_ANNOUNCEMENTS'] : ((isset($user->lang['ANNOUNCEMENTS'])) ? $user->lang['ANNOUNCEMENTS'] : '{ ANNOUNCEMENTS }')); } else { echo ((isset($this->_rootref['L_TOPICS'])) ? $this->_rootref['L_TOPICS'] : ((isset($user->lang['TOPICS'])) ? $user->lang['TOPICS'] : '{ TOPICS }')); } echo (isset($this->_tpldata['DEFINE']['.']['MG_BLOCK_H_END'])) ? $this->_tpldata['DEFINE']['.']['MG_BLOCK_H_END'] : ''; ?>
